...
<div class="dlg_title">Thành viên: <c:out value="${indname}"></c:out>
	<input type="button" id="btn_back" value="Trở lại" onclick="back()" style="float: right">	
</div>
<!-- edit -->
<div class="ucp_def_right " id="dlg_tmform" style="width: 43.4%;float:left">
            ...
            <div class="ctab" id="tab1">
                <table border="0" style="width: 100%" class="frm_data">     
                    ...
                    <tr>
                        ...
                        <td><input type="text" style="width: 270px" name="FullName" id="FullName"></td>
                        <td rowspan="4" style="width: 110px; vertical-align: top">                       
                        	<form id="frm1" method="POST" action="http://localhost:8080/adv/individual/ae?id=<c:out value="${indid }"/>" enctype="multipart/form-data">
                        		<img id="avatar" name="avatar" style="width: 100%;border:1px solid #ccc; max-height: 130px" src="/adv/adimgs/${childavatar}">
                        ...
                        <a href="javascript:choseimgs()" id="btn_changeimg" class="aubtn browse">Chọn ảnh</a>
                        <a onclick="agree()" id="btn_changeimg1" class="aubtn browse">Chấp nhận</a>
                        </td>
                    </tr>
                    <tr>
                        <td>Tên Vợ/Chồng</td>
                        <td><input type="text" name="PartnerName" id="PartnerName" style="width: 270px"></td>
                    </tr>
                    <tr>
                        <td>Ngày sinh</td>
                        <td><input type="text" style="width: 100px" name="BirdDate" id="BirdDate"> <span class="legend">(Định dạng Ngày/Tháng/Năm)</span></td>  
                    </tr>
                    <tr>
                        <td>Con thứ</td>
                        <td>
                            <select id="cboOrderInFamily" style="width: 105px; height: 25px"><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select> <span class="legend">(Thứ tự trong gia đình)</span>
                        </td>
                    </tr>
                    <tr>
                        <td>Giới tính</td>
                        <td>
                            <select id="cboGender" style="width: 105px; height: 25px">
                    ...
                    <tr>
                        ...
                        <td style="width: 280px">
                            <select id="cboLiveStatus" onchange="change()" style="width: 105px; height: 25px; float: left">
                                <option selected="selected" value="1">Còn sống</option>
                                <option value="2">Đã mất</option>
                            </select>
                            <div id="rip_box" class="rip_box" style="padding-left: 10px; float: left;display:none">Ngày mất <input type="text" style="width: 100px" name="RipDate" id="RipDate"></div>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        <td colspan="3" style="padding-top: 15px !important; vertical-align: top">
                        <input type="button" id="btn_save" onclick="addind()" value="Thêm mới" style="float: left">                  
                        </td>
                    </tr>
                </tbody></table>
            </div>
 ...
 <div class="ucp_def_right " id="dlg_tmform" style="width: 43%;float:left">
        ...
        <div class="tabct">
            <div class="ctab" id="tab1">
                <table border="0" style="width: 100%" class="frm_data">     
                    ...
                    <tr>
                        <td style="width: 85px">Họ và tên</td>
                        <td><input type="text" style="width: 270px" name="FullName2" id="FullName2" value="<c:out value="${indname }"/>"></td>
                        <td rowspan="4" style="width: 110px; vertical-align: top">
                        <form id="frm" method="POST" action="http://localhost:8080/adv/individual/ae?id=<c:out value="${indid }"/>" enctype="multipart/form-data">
                        	<img id="avatar1" name="avatar1"  style="width: 100%;border:1px solid #ccc; max-height: 130px" src="/adv/adimgs/${indavatar }">                 
                        	<input type="file" onchange="changeimg1(event)" id="real1" name="real1" accept=".png, .jpg, .jpeg" hidden="hidden" /> 
                      	                     	
                        </form>
                        </td>
                        <td rowspan="4" style="vertical-align: top"><a onclick="choseimgs1()" id="btn_changeimg1" class="aubtn browse">Chọn ảnh</a>
                        <a onclick="agree1()" id="btn_changeimg1" class="aubtn browse">Chấp nhận</a>
                        </td>
                    </tr>
                    <tr>
                        <td>Tên Vợ/Chồng</td>
                        <td><input type="text" name="PartnerName2" id="PartnerName2" value="<c:out value="${indpartnername }"/>" style="width: 270px"></td>                       
                    </tr>
                    <tr>
                        <td>Ngày sinh</td>
                        <td><input type="text" style="width: 100px" name="BirdDate2" id="BirdDate2" value="<c:out value="${indbirth}"/>"> <span class="legend">(Định dạng Năm/Tháng/Ngày)</span></td>  
                    </tr>
                    <tr>
                        <td>Ngày mất</td>
                        <td><input type="text" style="width: 100px" name="DeathDate2" id="DeathDate2" value="<c:out value="${inddeath}"/>"> <span class="legend">(Định dạng Năm/Tháng/Ngày)</span></td>  
                    </tr>
                    <tr>
                        <td>Giới tính</td>
                        <td>
                            <select id="cboGender2" style="width: 105px; height: 25px">
                                <option value="0">Nữ</option>
                                <option value="1" selected="selected">Nam</option>
                            </select>
                        </td>
                    ...
                    <tr>
                        <td></td>
                        <td colspan="3" style="padding-top: 15px !important; vertical-align: top">
                        	<input type="button" onclick="updateind()" value="Cập nhật" style="float: left">                      	
                        </td>
                    </tr>
                </tbody></table>
...
function updateind(){
	$("#frm_msg").html('<img src="<c:url value='/adimgs/loading1.gif'/>">Đang xử lý..');
	var fuln;
	if($("#PartnerName2").val()!=""){
		fuln = ($("#FullName2").val()) +" & "+ ($("#PartnerName2").val());
	}else{
		fuln = $("#FullName2").val();
	}
	if(fuln==""){
	...
	if($("#DeathDate2").val()!=""){
		if(!$("#DeathDate2").val().match(/\d{4}[/-]\d{1,2}[/-]\d{1,2}/)){			
			$("#frm_msg").html('');
			alert("Sai định dạng ngày(Năm/Tháng/Ngày)");
			return;
		}
	...
	try{
		...
		var url = "http://localhost:8080/adv/individual/ae?id=<c:out value='${indid}'/>&action=edit&data="+encodeURIComponent(datastr);
...
function addind(){
	$("#frm_msg").html('<img src="<c:url value='/adimgs/loading1.gif'/>">');
	if($("#FullName").val()==""){
		$("#frm_msg").html('');
		alert("Tên thành viên không được để trống");
		return;
	...
	try{
		var fuln;
		if($("#PartnerName").val()!=""){
			fuln = ($("#FullName").val()) +" & "+ ($("#PartnerName").val());
		}else{
			fuln = $("#FullName").val();
		}
		...
		var data={
			...
			branch : "<c:out value='${indbranch}'/>."+$("#cboOrderInFamily option:selected").val(),
			parentage_id : "<c:out value='${indprid}'/>",
			avatar : document.getElementById("avatar").src
		};
		var datastr = JSON.stringify(data);	
		var url = "http://localhost:8080/adv/individual/ae?id=<c:out value='${indid}'/>&action=add&data="+encodeURIComponent(datastr);
		request.onreadystatechange = function(){
			if(this.readyState == 4&& this.status == 200){
				alert(request.responseText);
